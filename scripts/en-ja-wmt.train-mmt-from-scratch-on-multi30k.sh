...
FEAT_PATH="./data/multi30k.en-ja.wmt/resnet101_faster_rcnn_genome_imgfeats"
DUMP_PATH="./models/multi30k_wmt"
...
python train.py --beam_size 8 --exp_name ${EXP_NAME} --dump_path ${DUMP_PATH} \
  ...
  --lgs 'en-ja' --mmt_step "en-ja" --emb_dim 512 --n_layers 6 --n_heads 8 \
  ...
  --stopping_criterion 'valid_en-ja_mmt_bleu,20' --validation_metrics 'valid_en-ja_mmt_bleu' \
